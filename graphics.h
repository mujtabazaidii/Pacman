...
void getboardDimensions(int& width, int& height); // gets width and height of the board
void getConsoleboardDimensions(int& width, int& height); // gets width and height of console board (in character mode)
...
void getboardDimensions(int& width, int& height)
{
	HWND consoleHandle = GetConsoleWindow();
	RECT rc;
...
void getConsoleboardDimensions(int& width, int& height)
{
	HANDLE consoleHandle = GetStdHandle(STD_OUTPUT_HANDLE);
	CONSOLE_SCREEN_BUFFER_INFO csbi;
